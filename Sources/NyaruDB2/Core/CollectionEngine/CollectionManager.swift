...
public class CollectionManager {
    ...
    public func createCollection(storage: StorageEngine, statsEngine: StatsEngine,name: String, indexes: [String] = [], partitionKey: String) -> NDBCollection {
        let newCollection = NDBCollection(storage: storage, statsEngine: statsEngine, name: name, indexes: indexes, partitionKey: partitionKey)
